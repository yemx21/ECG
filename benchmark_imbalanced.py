...
if __name__ == "__main__":
    ...
    expsnum=5
    #print('gru with raw...')
    #console.bench('gru', 'raw', 'leads', timesteps, numclasses, batchsize, expsnum, balanced)
    #print('gru with waveletdb1lvl3...')
    #console.bench('gru', 'waveletdb1lvl3', 'leads', timesteps, numclasses, batchsize, expsnum, balanced)

    #print('lstm with raw...')
    #console.bench('lstm', 'raw', 'leads', timesteps, numclasses, batchsize, expsnum, balanced)
